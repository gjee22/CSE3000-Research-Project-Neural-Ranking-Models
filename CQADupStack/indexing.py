...
def main():
    """
        Create Fast-Forward index for CQADupStack English
    """
    if not pt.started():
    ...
    ff_index = OnDiskIndex(
        Path("ffindex_cqadupstack_english_tct.h5"), dim=768, query_encoder=q_encoder, mode=Mode.MAXP, max_id_length=6
    )
